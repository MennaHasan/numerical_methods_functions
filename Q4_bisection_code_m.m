function [root,e_approx,iter]= Q4_bisection_code_m(xl,xu,imax,e_stopping,p,k)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
test=calculatef_m(xl,p,k)*calculatef_m(xu,p,k);
if test > 0
...
while (1) 
    ...
    test=calculatef_m(xl,p,k)*calculatef_m(root,p,k); 
    % We are calling a function named calculatef to calculate f(x).
